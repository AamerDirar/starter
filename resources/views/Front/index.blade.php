...
<body>
    ...
    <header id="header">
        <div class="d-flex flex-column">
            ...
            <div class="profile">
                <img src="{{ asset('assets/Front/img/profile-img.jpg') }}" alt="" class="img-fluid rounded-circle">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4" data-aos="fade-right">
                        <img src="{{ asset('assets/Front/img/profile-img.jpg') }}" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('assets/Front/img/portfolio/portfolio-1.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-links">
                                <a href="{{ asset('assets/Front/img/portfolio/portfolio-1.jpg') }}"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('assets/Front/img/portfolio/portfolio-3.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-links">
                                <a href="{{ asset('assets/Front/img/portfolio/portfolio-3.jpg') }}"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('assets/Front/img/portfolio/portfolio-4.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-links">
                                <a href="{{ asset('assets/Front/img/portfolio/portfolio-4.jpg') }}"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('assets/Front/img/portfolio/portfolio-5.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-links">
                                <a href="{{ asset('assets/Front/img/portfolio/portfolio-5.jpg') }}"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('assets/Front/img/portfolio/portfolio-6.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-links">
                                <a href="{{ asset('assets/Front/img/portfolio/portfolio-6.jpg') }}"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('assets/Front/img/portfolio/portfolio-7.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-links">
                                <a href="{{ asset('assets/Front/img/portfolio/portfolio-7.jpg') }}"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('assets/Front/img/portfolio/portfolio-8.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-links">
                                <a href="{{ asset('assets/Front/img/portfolio/portfolio-8.jpg') }}"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('assets/Front/img/portfolio/portfolio-9.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-links">
                                <a href="{{ asset('assets/Front/img/portfolio/portfolio-9.jpg') }}"
                                    data-gall="portfolioGallery" class="venobox" title="Web 3"><i
                                        class="bx bx-plus"></i></a>
                                <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                            </div>
    ...
    <script src="{{ asset('assets/Front/vendor/typed.js/typed.min.js') }}"></script>
